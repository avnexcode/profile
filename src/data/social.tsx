...
export const socialUrl: typeSocialMedia[] = [
  {
    name: "Instagram",
    url: "https://instagram.com/fauzi.n4_",
    icon: (
      <svg
  ...
  },
  {
    ...
    icon: (
      <svg
        className="w-[35px] h-[40px] lg:w-[43px] lg:h-[43px]"
  ...
  },
  {
    ...
    icon: (
      <svg
        className="w-[35px] h-[40px] lg:w-[40px] lg:h-[50px]"
        viewBox="0 0 73 73"
        version="1.1"
        xmlns="http://www.w3.org/2000/svg"
        fill="#000000"
  ...
  },
  {
    ...
    icon: (
      ...
      >
        ...
        ></g>
        <g id="SVGRepo_iconCarrier">
          <rect x="4" y="4" width="40" height="40" fill="#0077B5" />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
